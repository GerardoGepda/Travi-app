...
class PearReg extends StatefulWidget {
  @override
  _PearLoginState createState() => _PearLoginState();
}

class _PearLoginState extends State<PearReg> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              _textField("Usuario", false),
              _textField("Email", true),
              _textField("Contraseña", false),
              _textField("Confirmar contraseña", true),
              _keepLogin,
              _loginButton,
            ],
          ),
